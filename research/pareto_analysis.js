const algos = ["3-way Merge Sort","3-Way Quicksort","4-way Merge Sort","Binary Insertion","Bitonic Sort","BlockQuicksort","BogoBogoSort","Bogosort","Bottom-up Merge Sort","Bubble Sort","Circle Sort","Cocktail Selection","Cocktail Shaker","Comb Sort","Cycle Sort","Double Selection","Dual-Pivot Quicksort","Exit Sort","Ford-Johnson","Full Rank","Genghis Khan Sort","Gnome Sort","Hater Sort","Hayate-Shiki","Heap Sort","In-place Merge Sort","Insertion Sort","Intelligent Design","Intro Sort","Merge Sort","Miracle Sort","Natural Merge Sort","Odd-Even Sort","Pancake Sort","Parallel Merge Sort","Parallel Quicksort","Patience Sort","PDQSort","Ping-pong Merge Sort","Powersort","Quantum Bogo","Quicksort (Hoare)","Quicksort (LTR)","Quicksort (Middle)","Quicksort (Mo3)","Quicksort (Ninther)","Quicksort (Random)","Quicksort (RTL)","Random Sort","Selection Sort","Shellsort","Silly Sort","Sleep Sort","Slowsort","Smooth Sort","Socialist Sort","Stable Quicksort","Stalin Sort","Stooge Sort","Strand Sort","Thanos Sort","Timsort","Tournament Sort","Tree Sort","Triple-Pivot Quicksort"];
const battles = [567.63,100.79,543.54,531.09,1035.97,721.02,45.18,4950,558.55,2557.88,1213.2,2750.03,2581.88,850.98,525.11,2754.16,647.93,0,526.97,4950,99,2578.12,196.09,935.06,98.52,541.97,2545.65,0,724.65,541.96,99,577.16,2602.98,3080.19,558.11,648.72,198.77,193.79,558.4,562.93,1.71,195.29,653.62,645.95,713.57,604.38,650.47,650.24,257.28,2761.1,670.96,138,100,1324.61,100.03,0,652.56,99,2896.27,744.92,99,533.01,558.63,647.78,536.5];
const tau = [0.8807,0.3512,0.9021,0.887,0.9577,0.8072,0.0975,1,0.8874,0.8013,0.9691,0.9218,0.8072,0.9746,0.4193,0.9222,0.8368,0.0023,0.8885,1,0.319,0.8023,0.6611,0.7832,0.484,0.9053,0.8011,-0.0005,0.8072,0.9034,0.5432,0.8924,0.8051,0.9681,0.8859,0.8372,0.4817,0.5325,0.8867,0.9074,0.02,0.5138,0.8365,0.8366,0.8271,0.8421,0.837,0.8376,0.6627,0.8908,0.9324,0.24,0.001,0.9486,0.4834,0.0007,0.8375,0.1056,0.9898,0.8223,0.5453,0.8961,0.8868,0.8361,0.8256];
const dups = [false,true,false,false,true,false,true,true,false,true,true,true,true,true,true,true,false,false,false,false,false,true,true,true,true,false,false,false,false,false,false,true,true,true,false,false,true,true,false,true,false,true,false,false,true,true,false,false,true,true,true,true,false,true,true,false,false,false,true,false,true,true,false,false,true];
