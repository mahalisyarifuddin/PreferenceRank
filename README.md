...
- **Quick Rank:** Uses the **Ford-Johnson Algorithm** (Merge-Insertion Sort) to minimize comparisons (Battles ≈ 1.35 N ln N). It guarantees 100% sorting accuracy while drastically reducing time.
